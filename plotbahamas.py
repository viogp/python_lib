...
def mf_sims(redshift,massdef,sims,labels,env,dirplot=None,Testing=False):
    """
    ...
    ExamplesL050N256/WMAP9_PMGRID1024/Sims/ws_96_84_mu_7_76_dT_7_71_n_24_BH_DensTh_m_2_76_nt
    ---------
    >>> import plotbahamas as pb
    >>> pb.mf_sims(7.,'Group_M_Mean200',['L050N256/WMAP9_PMGRID1024/Sims/ws_96_84_mu_7_76_dT_7_71_n_24_BH_DensTh_m_2_76_ntask128'],['ntask128'],'cosma')
    """ 
...
#
    ...
    if (not os.path.exists(dirp)):
        os.makedirs(dirp)
    plotf = dirp+'mf_sims_z'+str(redshift)+'_'+massdef+'.pdf'
    print(plotf) #here
    fig.savefig(plotf)
...
if __name__== "__main__":
    ...
    if (env == 'cosma'):
        ...
        print(mf_sims(7.,'Group_M_Mean200',sims,labels,'cosma',Testing=True))
